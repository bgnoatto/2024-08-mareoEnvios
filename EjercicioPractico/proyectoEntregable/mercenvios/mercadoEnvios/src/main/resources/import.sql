insert into customer (id, first_name, last_Name, address, city) values (1, 'Marcos', 'Gutierrez', 'la buena direccion 123', 'CABA');
insert into customer (id, first_name, last_Name, address, city) values (2, 'Hernan', 'Toledo', 'falsa 456', 'CABA');
insert into customer (id, first_name, last_Name, address, city) values (3, 'Silvina', 'Hernandez', 'Marcos Paz 997', 'Buenos Aires');
...
--insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (1, 1, 'delivered', CURRENT_DATE - 4, CURRENT_DATE, 0);
--insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (2, 2, 'inTravel', CURRENT_DATE - 4, null, 2);
--insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (3, 1, 'initial', CURRENT_DATE, null, 2);
--insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (4, 3, 'cancelled', CURRENT_DATE - 3, null, 2);

insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (1, 1, 'initial', CURRENT_DATE - 4, CURRENT_DATE, 0);
insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (2, 2, 'initial', CURRENT_DATE - 4, null, 2);
insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (3, 1, 'initial', CURRENT_DATE, null, 2);
insert into Shipping (id, customer_id, state, send_date, arrive_date, priority) values (4, 3, 'initial', CURRENT_DATE - 3, null, 2);
